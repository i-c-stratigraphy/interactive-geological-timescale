<template>
    <div id="header">
        ...
        <p>An interactive version of the <a href="http://www.stratigraphy.org/index.php/ics-chart-timescale">International Chronostratigraphic Chart</a>, based on it's <a href="https://www.w3.org/standards/semanticweb/">Semantic Web</a> representation.</p>
